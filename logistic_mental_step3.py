...
# Reduce the dataset to 50,000 samples
...
for num_features in range(1, 11):
    ...
    # Train a Logistic Regression model on the entire training set
    log_reg = LogisticRegression()
    log_reg.fit(X_train_selected, y_train)

    # Make predictions on the test set
    y_pred_test = log_reg.predict(X_test_selected)
...
#results_df.to_excel("D:/Sem4/ML/Project/Results/logistic_regression_results_100000samples.xlsx", index=False)
